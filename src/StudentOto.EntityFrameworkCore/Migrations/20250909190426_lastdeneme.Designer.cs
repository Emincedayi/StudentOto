...
{
    [DbContext(typeof(StudentOtoDbContext))]
    [Migration("20250909190426_lastdeneme")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentOto.Domain.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StudentOto.Domain.Entities.Enrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StudentOto.Domain.Entities.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StudentOto.Domain.Entities.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StudentOto.Domain.Entities.Course", b =>
                {
                    b.HasOne("StudentOto.Domain.Entities.Teacher", "Teacher")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("StudentOto.Domain.Entities.Enrollment", b =>
                {
                    b.HasOne("StudentOto.Domain.Entities.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudentOto.Domain.Entities.Student", "Student")
                        .WithMany("Enrollments")
