...
public class StudentOtoDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        StudentOtoGlobalFeatureConfigurator.Configure();
        StudentOtoModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<StudentOtoDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<StudentOtoResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/StudentOto");

            options.DefaultResourceType = typeof(StudentOtoResource);
        ...
        {
            options.MapCodeNamespace("StudentOto", typeof(StudentOtoResource));
        });
    }
}
